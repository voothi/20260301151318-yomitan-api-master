...
selected_browsers = browsers if not choice or choice == "0" else [browsers[int(choice) - 1]]
...
if platform_data["platform"] == "mac":
    mac_install_path = platform_data["manifest_install_data"][selected_browsers[0]]["path"]
