...
[![Version](https://img.shields.io/badge/version-v1.1.2-blue)](https://github.com/Kuuuube/yomitan-api) [![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)
...
This error appears in an old version of `yomitan_api.py`. Update to v1.1.2 — it includes a guard that returns `None` instead of attempting the oversized read.
